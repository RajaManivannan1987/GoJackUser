...
//        setContentView(R.layout.dialog_coupon);
        ...
        adapter = new CouponRecyclerViewAdapter(CouponActivity.this, data, applyCouponButton);
        ...
        applyCouponButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                List<GetCoupon> stList = (adapter)
                        .getStudentist();
                if (stList.isEmpty()) {
                    ConstantFunctions.toast(CouponActivity.this, "No coupon available");
                } else {
...
//                            ConstantFunctions.toast(CouponActivity.this, "No coupon selected");
