...
import com.calljack.im028.calljack.ActivityClasses.CourierDetailsActivity;
import com.calljack.im028.calljack.ActivityClasses.HistoryDetailsActivity;
...
public class TripHistoryRecyclerViewAdapter extends RecyclerView.Adapter<TripHistoryRecyclerViewAdapter.CustomViewHolder> {
    ...
    public void onBindViewHolder(CustomViewHolder holder, final int position) {
        ...
        holder.amountTextview.setText( "Rs " +data.get(position).getFinal_amount());
